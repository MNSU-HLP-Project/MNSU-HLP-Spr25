...
from .views import get_entries, create_entry, delete_entry, get_entries_by_lookfor_number, get_entries_by_date, get_entries_by_hlp, get_entries_by_supervisor_students
...
urlpatterns = [
    ...
    path("student-entries/", get_entries_by_supervisor_students, name ="get_entries_by_supervisor_students"),
]
