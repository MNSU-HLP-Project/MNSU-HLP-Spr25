...
const AdminView = () => {
  ...
  return (
    <>
      ...
      {/* Invite Link Section */}
      <button
        className="w-3/4 p-3 md:p-5 border-2 border-blue-700 text-white bg-blue-700 rounded-lg hover:bg-blue-800 flex items-center justify-center shadow-lg transition duration-300 transform hover:scale-105 font-semibold text-xl md:text-2xl"
